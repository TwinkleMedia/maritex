...
<!-- ===================== HERO SECTION ===================== -->
<section class="relative w-full h-[60vh] flex flex-col overflow-hidden">
...
<section class="w-full py-16 bg-white">
  <div class="max-w-6xl mx-auto px-6 md:px-10">
    ...
    <div class="flex flex-col items-center mb-14">
      ...
      <h2 class="font-poppins font-semibold text-[#254991] text-2xl sm:text-3xl tracking-widest uppercase">Contact Us</h2>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12">
      ...
      <div class="lg:col-span-2 flex flex-col gap-5">
        ...
        <!-- Info Header -->
        <div>
          <h3 class="font-poppins font-semibold text-[#254991] text-xl leading-snug mb-2">Let's Work Together</h3>
        ...
        <!-- Divider -->
        <div class="w-12 h-[2px] bg-[#254991] rounded-full"></div>

        <!-- Info Cards -->
        <div class="flex flex-col gap-4">

          <!-- Phone -->
          <div class="flex items-start gap-4 bg-gray-50 border border-gray-100 rounded-2xl px-5 py-4 hover:border-[#254991] hover:shadow-md transition-all duration-300">
            <div class="flex-shrink-0 w-11 h-11 rounded-xl bg-[#254991]/10 border border-[#254991]/20 flex items-center justify-center mt-0.5">
            ...
            <div>
              ...
              <a href="tel:+911234567890" class="font-poppins font-semibold text-[#254991] text-sm hover:opacity-70 transition-opacity">+91 12345 67890</a>
          ...
          <div class="flex items-start gap-4 bg-gray-50 border border-gray-100 rounded-2xl px-5 py-4 hover:border-[#254991] hover:shadow-md transition-all duration-300">
            ...
            <div>
              ...
              <a href="mailto:info@globaltrading.com" class="font-poppins font-semibold text-[#254991] text-sm hover:opacity-70 transition-opacity">info@globaltrading.com</a>
          ...
          <div class="flex items-start gap-4 bg-gray-50 border border-gray-100 rounded-2xl px-5 py-4 hover:border-[#254991] hover:shadow-md transition-all duration-300">
            ...
            <div>
              ...
              <p class="font-poppins font-semibold text-[#254991] text-sm">Mumbai, Maharashtra</p>
          ...
          <div class="flex items-start gap-4 bg-gray-50 border border-gray-100 rounded-2xl px-5 py-4 hover:border-[#254991] hover:shadow-md transition-all duration-300">
            ...
            <div>
              ...
              <p class="font-poppins font-semibold text-[#254991] text-sm">Mon – Sat: 9:00 AM – 6:00 PM</p>
        ...
        <!-- Navy CTA Banner -->
        <div class="relative bg-[#254991] rounded-2xl overflow-hidden px-5 py-6 mt-1">
          ...
          <a href="tel:+911234567890"
            class="relative z-10 inline-flex items-center gap-2 font-poppins font-semibold text-xs tracking-widest uppercase bg-white text-[#254991] hover:bg-[#7eb3ff] hover:text-white px-5 py-2.5 rounded-lg transition-all duration-300">
        ...
        <div class="bg-white border border-gray-100 rounded-2xl shadow-sm p-7 sm:p-9 hover:shadow-lg transition-shadow duration-300">
          ...
          <div class="mb-7">
            <div class="flex items-center gap-2 mb-2">
              <span class="block w-5 h-[2px] bg-[#254991] rounded-full"></span>
              <span class="font-poppins text-[#254991] text-[10px] tracking-[0.3em] uppercase">Send a Message</span>
            </div>
          ...
          <form id="contactForm" onsubmit="handleSubmit(event)" novalidate>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
              ...
              <div class="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  class="font-poppins text-sm text-gray-700 bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 outline-none focus:border-[#254991] focus:bg-white focus:ring-2 focus:ring-[#254991]/10 transition-all duration-300 placeholder:text-gray-300"
                  required
                />
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
              ...
              <div class="flex flex-col gap-1.5">
                ...
                <div class="relative">
                  <select
                    id="service"
                    class="w-full font-poppins text-sm text-gray-700 bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 outline-none focus:border-[#254991] focus:bg-white focus:ring-2 focus:ring-[#254991]/10 transition-all duration-300 appearance-none cursor-pointer"
                    required
                  >
            ...
            <div class="flex flex-col gap-1.5 mb-6">
              ...
              <textarea
                ...
                class="font-poppins text-sm text-gray-700 bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 outline-none focus:border-[#254991] focus:bg-white focus:ring-2 focus:ring-[#254991]/10 transition-all duration-300 resize-none placeholder:text-gray-300"
                required
              ></textarea>
            ...
            <button
              type="submit"
              id="submitBtn"
              class="w-full font-poppins font-semibold text-xs tracking-widest uppercase bg-[#254991] hover:bg-[#1a3570] text-white px-8 py-4 rounded-xl transition-all duration-300 shadow-md hover:shadow-lg hover:-translate-y-0.5 flex items-center justify-center gap-3"
            >
...
<section class="w-full bg-gray-50 py-16">
  <div class="max-w-6xl mx-auto px-6 md:px-10">
    ...
    <div class="flex flex-col items-center mb-10">
      <div class="w-16 h-[3px] bg-[#254991] mb-4 rounded-full"></div>
      <h2 class="font-poppins font-semibold text-[#254991] text-2xl sm:text-3xl tracking-widest uppercase">Find Us</h2>
    ...
    <div class="relative rounded-2xl overflow-hidden shadow-md border border-gray-100 h-72 sm:h-96">
      ...
      ></iframe>
      <!-- Map Overlay Badge -->
      <div class="absolute top-4 left-4 bg-[#254991] text-white rounded-xl px-4 py-2.5 shadow-lg flex items-center gap-2">
        <svg class="w-4 h-4 text-[#7eb3ff]" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0zM15 11a3 3 0 11-6 0 3 3 0 016 0z"/>
        </svg>
